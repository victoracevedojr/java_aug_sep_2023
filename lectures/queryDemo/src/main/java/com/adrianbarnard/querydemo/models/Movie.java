...
public class Movie {
    ...
    @JoinColumn(name="director_id") // Name of the foreign key we're creating in our movies table
    private Director movieDirector;
    
    @ManyToMany(fetch=FetchType.LAZY)
    @JoinTable(
    		name="performers_movies",
    ...
    public Movie(
    		...
    		Director movieDirector, List<Performer> performers) {
    	this.title = title;
    	this.rating = rating;
    	this.genre = genre;
