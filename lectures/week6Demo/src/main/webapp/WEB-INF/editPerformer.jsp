...
<body>
	...
	<h1>Let's edit this performer!</h1>
	<form:form modelAttribute="thisPerformer" method="POST" action="/performers/${ thisPerformer.id }/edit" class="form">
		...
		<input type="submit" value="Edit performer" class="btn"/>
	</form:form>
</body>
</html>